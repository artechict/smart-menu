...
app.post("/translate", async (c) => {
  try {
    ...
    targetLangs.forEach((lang) => {
      results[lang] = mockTranslations[lang] || text;
    });
...
// ../.wrangler/tmp/pages-oAId0H/functionsRoutes-0.5687643146224068.mjs
var routes = [
  {
    routePath: "/api/:route*",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-jYOQEb/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-jYOQEb/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.8995382163703498.mjs.map
