...
// .wrangler/tmp/pages-OfdPTP/functionsWorker-0.22538485652373774.mjs
  ...
  try {
    ...
    if (!ai) {
      ...
      targetLangs.forEach((lang) => {
        results2[lang] = `(Local) ${text}`;
      });
      return c.json({ translations: results2 });
    }
    const results = {};
...
// .wrangler/tmp/bundle-LpP7jJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-LpP7jJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.22538485652373774.js.map
